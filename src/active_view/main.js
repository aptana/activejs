 ...
 * DOM Library
 * -----------
 * The [[ActiveSupport.Element]] object is passed in as the second argument
 * to the constructor. It does not extend built in objects (notably Element
 ...
 * Aliasing
 * --------
 * It's useful in your instance methods to refer to the Builder and DOM
 * libraries by in shorthand. Using the same variable names as the
 * conrstuctor also makes it easier to refactor your code from the
 * constructor into instance methods.
 * 
 *     var builder = ActiveView.Builder;
