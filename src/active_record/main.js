 ...
 * == ActiveRecord ==
 * 
 * Javascript object relational mapper. Operates on an in memory hash
 * table which can be queried using the JavaScript APIs or SQL. Data
 * is loaded and persisted via JSON/REST. ActiveRecord.js shares
 * a similar vocabulary to the Ruby ActiveRecord implementation,
 * but uses JavaScript idioms and best practices -- it is not a direct port.
 * 
 * Setup
 * -----
 * ActiveRecord.connect(ActiveRecord.Adapters.);
