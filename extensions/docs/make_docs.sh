...
cp ../docs/sh.css ./docs/sh.css
cp ../docs/sh_javascript.js ./docs/sh_javascript.js
cp ../docs/sh_main.js ./docs/sh_main.js
cp ../docs/showdown.js ./docs/showdown.js
...
java -jar $1/libs/saxon8.jar \
    ...
    ClassHeaderFragment=$PWD/../extensions/website/docs/fragment.xml
